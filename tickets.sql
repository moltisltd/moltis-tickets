...
ALTER TABLE `organisation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Organisation ID';
ALTER TABLE `ticket`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Ticket ID';
ALTER TABLE `ticket_group`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Ticket Group ID';
ALTER TABLE `ticket_type`
